...
description = "Kotlin All Private IDEA Plugin"
...
dependencies {
    compile(project(":kotlin-allprivate-compiler-plugin"))
    ...
    testCompileOnly(project(":kotlin-allprivate-compiler-plugin"))
    testCompileOnly(project(":allprivate-ide-plugin"))
