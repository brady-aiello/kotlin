...
import org.jetbrains.kotlin.allprivate.AllPrivateCommandLineProcessor.Companion.SUPPORTED_PRESETS
import org.jetbrains.kotlin.allprivate.AllPrivateConfigurationKeys.ANNOTATION
import org.jetbrains.kotlin.allprivate.AllPrivateConfigurationKeys.PRESET
import org.jetbrains.kotlin.compiler.plugin.*
import org.jetbrains.kotlin.config.CompilerConfiguration
import org.jetbrains.kotlin.config.CompilerConfigurationKey
import org.jetbrains.kotlin.extensions.DeclarationAttributeAltererExtension

object AllPrivateConfigurationKeys {
...
class AllPrivateCommandLineProcessor : CommandLineProcessor {
    companion object {
        val SUPPORTED_PRESETS = mapOf(
            "ios" to listOf("com.jetbrains.kotlin.allprivate.IosInterface")
        )
/*      val SUPPORTED_PRESETS = mapOf(
            "spring" to listOf(
...
*/
        ...
        const val PLUGIN_ID = "org.jetbrains.kotlin.allprivate"
    }
...
class AllPrivateComponentRegistrar : ComponentRegistrar {
    override fun registerProjectComponents(project: MockProject, configuration: CompilerConfiguration) {
        ...
        DeclarationAttributeAltererExtension.registerExtension(project, CliAllPrivateDeclarationAttributeAltererExtension(annotations))
    }
}
