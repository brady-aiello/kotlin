...
interface PackageViewDescriptorAccessor {
    fun compute(
    ...
    object Default: PackageViewDescriptorAccessor {
    ...
    companion object {
        val CAPABILITY = ModuleCapability<PackageViewDescriptorAccessor>("PackageViewDescriptorAccessor")
    }
}
